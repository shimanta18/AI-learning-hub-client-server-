...
export default function ThemeToggle(): React.JSX.Element {
    ...
    return (
        <button
            onClick={toggleTheme}
            className="p-2 rounded-xl bg-slate-100 text-slate-700 hover:bg-slate-200 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 hover:ring-2 hover:ring-blue-500/50 transition-all duration-200"
