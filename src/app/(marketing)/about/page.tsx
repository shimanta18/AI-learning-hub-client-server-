    ...
    return (
        <div className="w-full min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-50 selection:bg-slate-200 dark:selection:bg-slate-800 transition-colors duration-200">
            ...
            <section className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-8 pt-20 pb-16">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-950 dark:text-white max-w-4xl leading-[1.1] mb-6">
                    We teach AI the way we wish we’d learned it.
                </h1>
                <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl leading-relaxed">
            ...
            <section className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 py-12 border-t border-slate-100 dark:border-slate-900">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">

                    {/* Pillar 1: Our Mission */}
                    <div className="p-6 bg-white border border-slate-100 rounded-2xl shadow-sm space-y-4 dark:bg-slate-900 dark:border-slate-800/60">
                        <div className="w-9 h-9 bg-slate-50 border border-slate-200/60 rounded-xl flex items-center justify-center text-slate-700 dark:bg-slate-950 dark:border-slate-800 dark:text-slate-300">
                            <ShieldMinus className="w-5 h-5 stroke-[2]" />
                        </div>
                        <h3 className="text-base font-bold text-slate-950 dark:text-white tracking-tight">Our mission</h3>
                    ...
                    <div className="p-6 bg-white border border-slate-100 rounded-2xl shadow-sm space-y-4 dark:bg-slate-900 dark:border-slate-800/60">
                        ...
                        <h3 className="text-base font-bold text-slate-950 dark:text-white tracking-tight">Our method</h3>
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                    ...
                    <div className="p-6 bg-white border border-slate-100 rounded-2xl shadow-sm space-y-4 dark:bg-slate-900 dark:border-slate-800/60">
                        ...
                        <h3 className="text-base font-bold text-slate-950 dark:text-white tracking-tight">Our promise</h3>
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
            ...
            <section className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 py-16">
                <div className="p-8 sm:p-12 bg-white border border-slate-100 rounded-2xl shadow-sm flex flex-col lg:flex-row lg:items-start justify-between gap-12 dark:bg-slate-900 dark:border-slate-800/60">

                    {/* Left text column */}
                    <div className="max-w-md space-y-4">
                        <h2 className="text-3xl font-black text-slate-950 dark:text-white">The team</h2>
                    ...
                    <div className="flex-grow grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl w-full">
                        {team.map((member, idx) => (
                            <div
                                key={idx}
                                className="flex items-center space-x-3.5 p-3.5 border border-slate-100 rounded-xl bg-white dark:bg-slate-950 dark:border-slate-800/50"
                            >
                                <div className="w-9 h-9 rounded-full bg-slate-950 text-white dark:bg-white dark:text-slate-950 text-[11px] font-black tracking-wider flex items-center justify-center select-none flex-shrink-0">
                                    {member.initials}
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-xs sm:text-sm font-bold text-slate-950 dark:text-white tracking-tight">{member.name}</span>
                                    <span className="text-[11px] text-slate-400 dark:text-slate-500 font-semibold">{member.role}</span>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 pb-20">
                <div className="w-full bg-slate-950 text-white p-8 sm:p-16 rounded-3xl space-y-6 relative overflow-hidden shadow-xl dark:border dark:border-slate-900">
